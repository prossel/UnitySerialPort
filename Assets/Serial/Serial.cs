...
//				case RuntimePlatform.OSXPlayer:
	...
	public IEnumerator ReadSerialLoopWin ()
	{
		...
		while (true) {
			...
			try {
				...
				Debug.Log ("System.TimeoutException in serial.ReadLine: " + e.ToString ());
			} catch (System.Exception e) {
				Debug.LogError ("System.Exception in serial.ReadLine: " + e.ToString ());
			}
	...
	public static bool checkOpen ()
	{
		...
		if (!s_serial.IsOpen) {
			...
			s_serial.PortName = portName;
			s_serial.BaudRate = portSpeed;
